...
Meta data (logical, Date, factor, ordered, POSIXct, unit and sfc columns) are only preserved when entire tables are downloaded through the `rws_read_sqlite()` functions.
